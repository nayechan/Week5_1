...
UPIEControlWindow* UUIWindowFactory::CreatePIEControlWindow(EUIDockDirection InDockDirection)
{
	auto* Window = new UPIEControlWindow();
	Window->GetMutableConfig().DockDirection = InDockDirection;
	return Window;
}
...
void UUIWindowFactory::CreateDefaultUILayout()
{
	...
	UIManager.RegisterUIWindow(CreatePIEControlWindow(EUIDockDirection::None));
