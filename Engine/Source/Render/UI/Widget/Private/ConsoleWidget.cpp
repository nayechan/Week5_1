...
void UConsoleWidget::HandleStatCommand(const FString& StatCommand)
{
	...
	else if (StatCommand == "picking")
	{
		StatOverlay.ShowPicking(true);
		AddLog(ELogType::Success, "Picking overlay enabled");
	}
	else if (StatCommand == "bvh")
	{
		StatOverlay.ShowBVH(true);
		AddLog(ELogType::Success, "BVH overlay enabled");
	}
	else if (StatCommand == "culling")
	{
		StatOverlay.ShowCulling(true);
		AddLog(ELogType::Success, "Culling overlay enabled");
	}
